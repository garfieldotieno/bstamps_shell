...
import random
import time 
from models import RequestTask, AccountSummary, Settlement, SessionLocal, SlotQuestion
...
if __name__ == '__main__':
    with app.app_context():
        # time.sleep(0.5)
        tele_bot.set_webhook(url="https://4ff1-2c0f-2a80-10c8-4f10-7552-fe64-b69e-2f19.ngrok-free.app/telegram")
