...
import uuid 
from Markup  import clear_prev_markup, main_markup, session_type_markup, prompt_input_markup
import re 
import json 
import requests
import asyncio
...
if __name__ == '__main__':
    with app.app_context():
        # time.sleep(0.5)
        tele_bot.set_webhook(url="https://f3cf-2c0f-2a80-10ed-e410-547b-9b0f-50a0-fc3c.ngrok-free.app/telegram")
